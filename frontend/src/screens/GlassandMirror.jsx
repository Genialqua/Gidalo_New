...
const GlassandMirrorScreen = () => {
  const { category = 'glassandmirror', pageNumber = 1, keyword = '' } = useParams();
            ...
            <Col md={9}>
              <Row>
                {data?.properties?.length > 0 ? (
                  ...
                  <>
                    <Message variant='info'>Order your glass and mirror here.</Message>
                    <Estimator />
                  </>
                )}
              </Row>
...
export default GlassandMirrorScreen;

...
const WardrobesandCabinetsScreen = () => {
  const { category = 'wardrobes and cabinets', pageNumber = 1, keyword = '' } = useParams();
            ...
            <Col md={9}>
              <Row>
                {data?.properties?.length > 0 ? (
                  ...
                  <>
                    <Message variant='info'>Order your wardrobes and cabinets here.</Message>
                    <Estimator />
                  </>
                )}
              </Row>
...
export default WardrobesandCabinetsScreen;

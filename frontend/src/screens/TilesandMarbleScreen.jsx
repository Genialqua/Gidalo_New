...
const TilesandMarbleScreen = () => {
  const { category = 'tilesandmarble', pageNumber = 1, keyword = '' } = useParams();
            ...
            <Col md={9}>
              <Row>
                {data?.properties?.length > 0 ? (
                  ...
                  <>
                    <Message variant='info'>Order your tiles and marble here.</Message>
                    <Estimator />
                  </>
                )}
              </Row>
...
export default TilesandMarbleScreen;

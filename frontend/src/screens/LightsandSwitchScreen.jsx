...
const LightsandSwitchScreen = () => {
  const { category = 'lightsandswitch', pageNumber = 1, keyword = '' } = useParams();
            ...
            <Col md={9}>
              <Row>
                {data?.properties?.length > 0 ? (
                  ...
                  <>
                    <Message variant='info'>Order your lights and switch here.</Message>
                    <Estimator />
                  </>
                )}
              </Row>
...
export default LightsandSwitchScreen;

...
const BuildersMartScreen = () => {
  const { category = 'buildersmart', pageNumber = 1, keyword = '' } = useParams();
            ...
            <Col md={9}>
              <Row>
                {data?.properties?.length > 0 ? (
                  ...
                  <>
                    <Message variant='info'>Order your building accessories here.</Message>
                    {/* <Estimator /> */}
                  </>
                )}
              </Row>
...
export default BuildersMartScreen;
